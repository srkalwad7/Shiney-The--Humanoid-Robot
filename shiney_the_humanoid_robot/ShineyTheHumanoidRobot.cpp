#include "ShineyTheHumanoidRobot.h"
...
void ShineyTheHumanoidRobot::init_hash() {
  pwm.begin();
...
/* Servo angle setting */
void ShineyTheHumanoidRobot::set_servo(int servo, int servo_pwm) {
  pwm.setPWM(servo, 0, servo_pwm);
}

/* Initial position */
void ShineyTheHumanoidRobot::initial_position() {
...
void ShineyTheHumanoidRobot::move_servo(int time, int  servo_target[]) {
...
/******************************************************************************************************/
void ShineyTheHumanoidRobot::initial_face() {
  display.clearDisplay();
  display.drawBitmap(0, 0, initialface, 128, 64, 1);
  display.display();
}
void ShineyTheHumanoidRobot::bink_eye(int bink_count) {
...
void ShineyTheHumanoidRobot::happy_face() {
  display.clearDisplay();
...
/******************************************************************************************************/
void ShineyTheHumanoidRobot::say_hi(int count) {
...
/******************************************************************************************************/
void ShineyTheHumanoidRobot::hands_up() {
...
/******************************************************************************************************/
void ShineyTheHumanoidRobot::hands_down() {
...
/******************************************************************************************************/
void ShineyTheHumanoidRobot::hand_wave(int count) {
...
/******************************************************************************************************/
void ShineyTheHumanoidRobot::right_leg_wave(int count) {
...
/******************************************************************************************************/
void ShineyTheHumanoidRobot::left_leg_wave(int count) {
...
/******************************************************************************************************/
void ShineyTheHumanoidRobot::leg_hand_shake(int count) {
...
/******************************************************************************************************/
void ShineyTheHumanoidRobot::right_slide_wave(int count) {
...
/******************************************************************************************************/
void ShineyTheHumanoidRobot::left_slide_wave(int count) {
...
/******************************************************************************************************/
void ShineyTheHumanoidRobot::move_forward(int steps, int speed) {
...
/******************************************************************************************************/
void ShineyTheHumanoidRobot::move_backward(int steps, int speed) {
...
/******************************************************************************************************/
void ShineyTheHumanoidRobot::turn_left(int steps, int speed) {
...
/******************************************************************************************************/
void ShineyTheHumanoidRobot::turn_right(int steps, int speed) {
...
/******************************************************************************************************/
void ShineyTheHumanoidRobot::side_move_right(int steps) {
...
/******************************************************************************************************/
void ShineyTheHumanoidRobot::side_move_left(int steps) {
...
/******************************************************************************************************/
void ShineyTheHumanoidRobot::flying_hand_wave(int count) {
...
/******************************************************************************************************/
void ShineyTheHumanoidRobot::jump(int count, int height) {
  if (height > 30) {
    height = 30;
  }
  for (int i = 1; i <= count; i++) {
...
/******************************************************************************************************/
void ShineyTheHumanoidRobot::leg_head_shake(int count) {
...
/******************************************************************************************************/
void ShineyTheHumanoidRobot::flying(int count) {
...
/******************************************************************************************************/
void ShineyTheHumanoidRobot::leg_shake(int count) {
...
/******************************************************************************************************/
void ShineyTheHumanoidRobot::hand_straight_shake(int count) {
